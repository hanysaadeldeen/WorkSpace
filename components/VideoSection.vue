<template>
  <section>
    <SectionsTitle title="جولة مرئية داخل Work Space ديجتال اوردر"
      description="استعرض تفاصيل المكان في دقيقة واحدة، من لحظة الدخول وحتى بداية يوم العمل." withButton
      buttonTitle="شاهد التجربة بنفسك" />
